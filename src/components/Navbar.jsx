...
import { r_logo, logo, menu, close } from "../assets";
  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          <img src={r_logo} alt="logo" className="w-9 h-9 object-contain" />
        ...
        {/* ---------------------  For Menu/Close icon on Moile Devices ---------------------   */}
        ...
        {/* ---------------------  For Links in menu/navbar of moile devices ---------------------  */}
        <div
            className={
